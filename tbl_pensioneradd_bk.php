...
<table id="tbl_tbl_pensioneradd" class="table table-bordered table-striped">
<?php if ($tbl_pensioner->PensionerID->Visible) { // PensionerID ?>
	<tr id="r_PensionerID">
		<td><span id="elh_tbl_pensioner_PensionerID"><?php echo $tbl_pensioner->PensionerID->FldCaption() ?></span></td>
		<td<?php echo $tbl_pensioner->PensionerID->CellAttributes() ?>>
<span id="el_tbl_pensioner_PensionerID" class="control-group">
<input type="text" data-field="x_PensionerID" name="x_PensionerID" id="x_PensionerID" size="30" maxlength="25" placeholder="<?php echo $tbl_pensioner->PensionerID->PlaceHolder ?>" value="<?php echo $tbl_pensioner->PensionerID->EditValue ?>"<?php echo $tbl_pensioner->PensionerID->EditAttributes() ?>>
</span>
<?php echo $tbl_pensioner->PensionerID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->InclusionDate->Visible) { // InclusionDate ?>
	<tr id="r_InclusionDate">
		<td><span id="elh_tbl_pensioner_InclusionDate"><?php echo $tbl_pensioner->InclusionDate->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->InclusionDate->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->hh_id->Visible) { // hh_id ?>
	<tr id="r_hh_id">
		<td><span id="elh_tbl_pensioner_hh_id"><?php echo $tbl_pensioner->hh_id->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->hh_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->osca_ID->Visible) { // osca_ID ?>
	<tr id="r_osca_ID">
		<td><span id="elh_tbl_pensioner_osca_ID"><?php echo $tbl_pensioner->osca_ID->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->osca_ID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->PlaceIssued->Visible) { // PlaceIssued ?>
	<tr id="r_PlaceIssued">
		<td><span id="elh_tbl_pensioner_PlaceIssued"><?php echo $tbl_pensioner->PlaceIssued->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->PlaceIssued->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->DateIssued->Visible) { // DateIssued ?>
	<tr id="r_DateIssued">
		<td><span id="elh_tbl_pensioner_DateIssued"><?php echo $tbl_pensioner->DateIssued->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->DateIssued->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->firstname->Visible) { // firstname ?>
	<tr id="r_firstname">
		<td><span id="elh_tbl_pensioner_firstname"><?php echo $tbl_pensioner->firstname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->firstname->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->middlename->Visible) { // middlename ?>
	<tr id="r_middlename">
		<td><span id="elh_tbl_pensioner_middlename"><?php echo $tbl_pensioner->middlename->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->middlename->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->lastname->Visible) { // lastname ?>
	<tr id="r_lastname">
		<td><span id="elh_tbl_pensioner_lastname"><?php echo $tbl_pensioner->lastname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->lastname->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->extname->Visible) { // extname ?>
	<tr id="r_extname">
		<td><span id="elh_tbl_pensioner_extname"><?php echo $tbl_pensioner->extname->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->extname->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->Birthdate->Visible) { // Birthdate ?>
	<tr id="r_Birthdate">
		<td><span id="elh_tbl_pensioner_Birthdate"><?php echo $tbl_pensioner->Birthdate->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->Birthdate->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->sex->Visible) { // sex ?>
	<tr id="r_sex">
		<td><span id="elh_tbl_pensioner_sex"><?php echo $tbl_pensioner->sex->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->sex->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->MaritalID->Visible) { // MaritalID ?>
	<tr id="r_MaritalID">
		<td><span id="elh_tbl_pensioner_MaritalID"><?php echo $tbl_pensioner->MaritalID->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->MaritalID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->affliationID->Visible) { // affliationID ?>
	<tr id="r_affliationID">
		<td><span id="elh_tbl_pensioner_affliationID"><?php echo $tbl_pensioner->affliationID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->affliationID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->psgc_region->Visible) { // psgc_region ?>
	<tr id="r_psgc_region">
		<td><span id="elh_tbl_pensioner_psgc_region"><?php echo $tbl_pensioner->psgc_region->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->psgc_region->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->psgc_province->Visible) { // psgc_province ?>
	<tr id="r_psgc_province">
		<td><span id="elh_tbl_pensioner_psgc_province"><?php echo $tbl_pensioner->psgc_province->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->psgc_province->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->psgc_municipality->Visible) { // psgc_municipality ?>
	<tr id="r_psgc_municipality">
		<td><span id="elh_tbl_pensioner_psgc_municipality"><?php echo $tbl_pensioner->psgc_municipality->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->psgc_municipality->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->psgc_brgy->Visible) { // psgc_brgy ?>
	<tr id="r_psgc_brgy">
		<td><span id="elh_tbl_pensioner_psgc_brgy"><?php echo $tbl_pensioner->psgc_brgy->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->psgc_brgy->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->given_add->Visible) { // given_add ?>
	<tr id="r_given_add">
		<td><span id="elh_tbl_pensioner_given_add"><?php echo $tbl_pensioner->given_add->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->given_add->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->Status->Visible) { // Status ?>
	<tr id="r_Status">
		<td><span id="elh_tbl_pensioner_Status"><?php echo $tbl_pensioner->Status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->Status->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($tbl_pensioner->paymentmodeID->Visible) { // paymentmodeID ?>
	<tr id="r_paymentmodeID">
		<td><span id="elh_tbl_pensioner_paymentmodeID"><?php echo $tbl_pensioner->paymentmodeID->FldCaption() ?></span></td>
...
<?php echo $tbl_pensioner->paymentmodeID->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<?php if ($tbl_pensioner->is_4ps->Visible) { // is_4ps ?>
	<tr id="r_is_4ps">
		<td><span id="elh_tbl_pensioner_is_4ps"><?php echo $tbl_pensioner->is_4ps->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php echo $tbl_pensioner->is_4ps->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
