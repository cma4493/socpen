...
?>
<form name="ftbl_representativeadd" id="ftbl_representativeadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">  <!-- tbl_pensionerview.php -->
