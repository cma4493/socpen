...
class cMenu {
	...
	function AddMenuItem($id, $text, $url, $parentid = -1, $src = "", $allowed = TRUE, $grouptitle = FALSE, $customurl = FALSE) {
		...
		//Tolits Customization
		if ($url==""){
			switch ($text)
			{
			case "Main Menu":
			  $text="<i class='icon-home'></i> <span class='menu-text'>".$text."</span>";
			  break;
			case "Reports":
				$text="<i class='icon-list-alt'></i> <span class='menu-text'>".$text."</span>";
				break;
			case "System Libraries":
			  $text="<i class='icon-cog'></i> <span class='menu-text'>".$text."</span>";
			  break;
			case "Access Controls":
			  $text="<i class='icon-cogs'></i> <span class='menu-text'>".$text."</span>";
			  break;
			...
			case "Change Password":
			  ...
			  break;
			case "Logout":
			  $text="<i class='icon-power-off'></i> <span class='menu-text'>".$text."</span>";
			  break;
			default:
			  $text="<i class='icon-double-angle-right'></i> <span class='menu-text'>".$text."</span>";
			  break;
