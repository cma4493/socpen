...
define("EW_PROJECT_NAME", "socpen_access", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{AC00512B-B959-4ABC-B03E-21192746C63D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ffxad3qUZMM5qhL3', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/socpen_access.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_PASS", 'masterpogi', TRUE);
define("EW_CONN_DB", 'db_pension_access_mkr', TRUE);
...
define("EW_USER_ID_FILTER", "(`uid` = %u)",  TRUE);
define("EW_USER_EMAIL_FILTER", "(`email` = '%e')",  TRUE);
define("EW_USER_ACTIVATE_FILTER", "(`activated` = 1)",  TRUE);
...
// Email
define("EW_SMTP_SERVER", "ssl://smtp.gmail.com", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 465, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "itsm-desk@dswd.gov.ph", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "m21l3rm0d3r@t0r123", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "socpen-noreply@dswd.gov.ph", TRUE); // Sender email address
...
define("EW_SUBMENU_CLASSNAME", "submenu", TRUE);
define("EW_SUBMENU_DROPDOWN_IMAGE", "<b class='arrow icon-angle-down'></b>", TRUE);
define("EW_MENU_DIVIDER_CLASSNAME", "", TRUE);
define("EW_MENU_ITEM_CLASSNAME", "", TRUE);
define("EW_SUBMENU_ITEM_CLASSNAME", "drpdown-toggle", TRUE);
define("EW_MENU_ACTIVE_ITEM_CLASS", "active", TRUE);
define("EW_SUBMENU_ACTIVE_ITEM_CLASS", "active open", TRUE);
