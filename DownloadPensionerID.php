...
include_once "excel/PensionerListDAO.php";
?>
<?php
...
<?php
if (isset($_REQUEST['codegenids'])){
	$paramExplode = explode("::",$_REQUEST['codegenids']);
	$errorLogDownload = $paramExplode[0];
	$codegenIdParam = $paramExplode[1];
	/**
	 * PHPExcel
	 *
...
// Add data to rows, starting at 2nd row
	$Pensioners = $PensionerListDAO->retList($codegenIdParam);
...
// Save Excel 2007 file
	...
	$directory = "excel/generatedfiles/";
...
// Echo done
	...
	echo "download logs: " . "<a href=\"".$errorLogDownload."\">" . "Click HERE" . "</a>", EOL;
} else {
	echo "<pre>";
