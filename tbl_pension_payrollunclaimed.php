...
<?php include_once "tbl_pension_payrollunclaimed_info.php" ?>
...
class ctbl_pension_payroll_list extends ctbl_pension_payroll {
	...
	function RenderListOptions() {
		...
		if ($Security->CanView())
			$oListOpt->Body = "<a class=\"blue\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("ViewLink")) . "\" href=\"tbl_pensionerview.php?showdetail=&SeniorID=" . $PensionerIDCustom->getSeniorID($this->PayrollID->CurrentValue) . "\">" . $Language->Phrase("ViewLink") . "<i class=\"icon-zoom-in bigger-130\"></i></a>";
		else
			$oListOpt->Body = "";
