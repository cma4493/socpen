...
//
// Table class for tbl_user_rito
//
class ctbl_user_rito extends cTable {
	var $uid;
	var $username;
	var $password;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_user_rito';
		$this->TableName = 'tbl_user_rito';
		...
		// uid
		$this->uid = new cField('tbl_user_rito', 'tbl_user_rito', 'x_uid', 'uid', '`uid`', '`uid`', 20, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// username
		$this->username = new cField('tbl_user_rito', 'tbl_user_rito', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['username'] = &$this->username;

		// password
		$this->password = new cField('tbl_user_rito', 'tbl_user_rito', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['password'] = &$this->password;

		// email
		$this->_email = new cField('tbl_user_rito', 'tbl_user_rito', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// firstname
		$this->firstname = new cField('tbl_user_rito', 'tbl_user_rito', 'x_firstname', 'firstname', '`firstname`', '`firstname`', 200, -1, FALSE, '`firstname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['firstname'] = &$this->firstname;

		// middlename
		$this->middlename = new cField('tbl_user_rito', 'tbl_user_rito', 'x_middlename', 'middlename', '`middlename`', '`middlename`', 200, -1, FALSE, '`middlename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['middlename'] = &$this->middlename;

		// surname
		$this->surname = new cField('tbl_user_rito', 'tbl_user_rito', 'x_surname', 'surname', '`surname`', '`surname`', 200, -1, FALSE, '`surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['surname'] = &$this->surname;

		// extensionname
		$this->extensionname = new cField('tbl_user_rito', 'tbl_user_rito', 'x_extensionname', 'extensionname', '`extensionname`', '`extensionname`', 200, -1, FALSE, '`extensionname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['extensionname'] = &$this->extensionname;

		// position
		$this->position = new cField('tbl_user_rito', 'tbl_user_rito', 'x_position', 'position', '`position`', '`position`', 200, -1, FALSE, '`position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['position'] = &$this->position;

		// designation
		$this->designation = new cField('tbl_user_rito', 'tbl_user_rito', 'x_designation', 'designation', '`designation`', '`designation`', 200, -1, FALSE, '`designation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['designation'] = &$this->designation;

		// region_code
		$this->region_code = new cField('tbl_user_rito', 'tbl_user_rito', 'x_region_code', 'region_code', '`region_code`', '`region_code`', 21, -1, FALSE, '`region_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->region_code->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['region_code'] = &$this->region_code;

		// user_level
		$this->user_level = new cField('tbl_user_rito', 'tbl_user_rito', 'x_user_level', 'user_level', '`user_level`', '`user_level`', 3, -1, FALSE, '`user_level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->user_level->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_level'] = &$this->user_level;

		// contact_no
		$this->contact_no = new cField('tbl_user_rito', 'tbl_user_rito', 'x_contact_no', 'contact_no', '`contact_no`', '`contact_no`', 200, -1, FALSE, '`contact_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['contact_no'] = &$this->contact_no;

		// activated
		$this->activated = new cField('tbl_user_rito', 'tbl_user_rito', 'x_activated', 'activated', '`activated`', '`activated`', 16, -1, FALSE, '`activated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->activated->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['activated'] = &$this->activated;

		// profile
		$this->profile = new cField('tbl_user_rito', 'tbl_user_rito', 'x_profile', 'profile', '`profile`', '`profile`', 201, -1, FALSE, '`profile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelect() { // Select
		return "SELECT tbl_user.* FROM " . $this->SqlFrom();
	}
	...
	function SqlWhere() { // Where
		...
		{
			$sWhere = "region_code=" . $UserClass->getUserRegion();
		}
		else
		{
			$sWhere = "";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbl_user_ritoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbl_user_ritoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_user_ritoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_user_ritoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_user_ritoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_user_ritodelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->region_code->Exportable) $Doc->ExportCaption($this->region_code);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->region_code->Exportable) $Doc->ExportField($this->region_code);
