...
$lib_brgy_edit = NULL; // Initialize page object first

class clib_brgy_edit extends clib_brgy {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->brgy_code->CurrentValue == "")
			$this->Page_Terminate("lib_brgylist.php"); // Invalid key, return to list
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->brgy_code->EditValue = $this->brgy_code->CurrentValue;
			$this->brgy_code->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// brgy_name
			$this->brgy_name->SetDbValueDef($rsnew, $this->brgy_name->CurrentValue, "", $this->brgy_name->ReadOnly);

			// city_code
			$this->city_code->SetDbValueDef($rsnew, $this->city_code->CurrentValue, 0, $this->city_code->ReadOnly);
...
// Create page object
if (!isset($lib_brgy_edit)) $lib_brgy_edit = new clib_brgy_edit();

// Page init
$lib_brgy_edit->Page_Init();

// Page main
$lib_brgy_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lib_brgy_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var lib_brgy_edit = new ew_Page("lib_brgy_edit");
lib_brgy_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = lib_brgy_edit.PageID; // For backward compatibility

// Form object
var flib_brgyedit = new ew_Form("flib_brgyedit");

// Validate form
flib_brgyedit.Validate = function() {
...
flib_brgyedit.Form_CustomValidate = 
...
flib_brgyedit.ValidateRequired = true;
<?php } else { ?>
flib_brgyedit.ValidateRequired = false; 
<?php } ?>
...
<?php $lib_brgy_edit->ShowPageHeader(); ?>
<?php
$lib_brgy_edit->ShowMessage();
?>
<form name="flib_brgyedit" id="flib_brgyedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="lib_brgy">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_lib_brgyedit" class="table table-bordered table-striped">
...
<?php echo $lib_brgy->brgy_code->EditValue ?></span>
</span>
<input type="hidden" data-field="x_brgy_code" name="x_brgy_code" id="x_brgy_code" value="<?php echo ew_HtmlEncode($lib_brgy->brgy_code->CurrentValue) ?>">
