...
class caudittrail_edit extends caudittrail {
	...
	function LoadFormValues() {
		...
		if (!$this->datetime->FldIsDetailKey) {
			...
			$this->datetime->CurrentValue = ew_UnFormatDateTime($this->datetime->CurrentValue, 6);
		}
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->datetime->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->datetime->CurrentValue, 6));
	...
	function ValidateForm() {
		...
		if (!ew_CheckUSDate($this->datetime->FormValue)) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// datetime
			$this->datetime->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->datetime->CurrentValue, 6), ew_CurrentDate(), $this->datetime->ReadOnly);
