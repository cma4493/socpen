...
<?php include_once "model/UserClass.php" ?>
<?php
...
class ctbl_pension_payroll_list extends ctbl_pension_payroll {
	...
	function __construct() {
		...
		$this->MultiSetClaimUrl = "tbl_pension_payrollclaim_button.php";
	...
	function SetupOtherOptions() {
		...
		// Add multi delete
		$item = &$option->Add("multisetclaim");
		$item->Body = "<a class=\"btn btn-primary btn-sm\" href=\"\" onclick=\"ew_SubmitSelected(document.ftbl_pension_payrolllist, '" . $this->MultiSetClaimUrl . "', ewLanguage.Phrase('setclaimmulticonfirmmsg'));return false;\">" . "Claimed" . "</a>";
		$item->Visible = ($Security->CanDelete());
...
<?php
$UserCLass = new UserClass($tbl_pension_payroll->Createdby->CurrentValue);
echo $UserCLass->getUserName();
?>
</span>
<a id="<?php echo $tbl_pension_payroll_list->PageObjName . "_row_" . $tbl_pension_payroll_list->RowCnt ?>"></a></td>
	<?php } ?>
...
<?php
$UserCLass = new UserClass($tbl_pension_payroll->UpdatedBy->CurrentValue);
echo $UserCLass->getUserName();
?>
</span>
<a id="<?php echo $tbl_pension_payroll_list->PageObjName . "_row_" . $tbl_pension_payroll_list->RowCnt ?>"></a></td>
