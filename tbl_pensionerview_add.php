...
include_once "model/custom_rep_add.php";
$custom_rep_add = new custom_rep_add();
?>
<?php if ($_REQUEST['addrepbtn'] == 1){ ?>
<!--<pre>-->
	<?php /*print_r($_REQUEST)*/ ?>
<!--</pre>-->
<?php
$jb_firstname = $_REQUEST['jb_firstname'];
$jb_middlename = $_REQUEST['jb_middlename'];
$jb_lastname = $_REQUEST['jb_lastname'];
$jb_lib_relationship = $_REQUEST['jb_lib_relationship'];
$jb_contactno = $_REQUEST['jb_contactno'];
$jb_region_code = $_REQUEST['jb_region_code'];
$jb_prov_code = $_REQUEST['jb_prov_code'];
$jb_city_code = $_REQUEST['jb_city_code'];
$jb_brgy_code = $_REQUEST['jb_brgy_code'];
$jb_houseno = $_REQUEST['jb_houseno'];
$jb_PensionerID = $_REQUEST['jb_PensionerID'];
$jb_SeniorID = $_REQUEST['jb_SeniorID'];
$resulter = $custom_rep_add->_executeInsert($jb_firstname,$jb_middlename,$jb_lastname,$jb_lib_relationship,$jb_contactno,$jb_region_code,$jb_prov_code,$jb_city_code,$jb_brgy_code,$jb_houseno,$jb_PensionerID,CurrentUserID());
	if ($resulter == 1) {
?>
		<div class="alert alert-success">
			Add Success!
		</div>
		<meta http-equiv="refresh" content="0.5; url=http://localhost/socpen_access/tbl_pensionerview.php?showdetail=&SeniorID=<?php echo $jb_SeniorID ?>" />
		<?php } else { ?>
		<div class="alert alert-danger">
			Error Saving!
		</div>
		<?php } ?>
<?php } elseif ($_REQUEST['addsupportbtn'] == 1){ ?>
	<!--<pre>-->
		<?php /*print_r($_REQUEST)*/ ?>
	<!--</pre>-->
	<?php
		$jb_PensionerID = $_REQUEST['jb_PensionerID'];
		$jb_SeniorID = $_REQUEST['jb_SeniorID'];
		$jb_family_support = $_REQUEST['jb_family_support'];
		$jb_kindsupport = $_REQUEST['jb_kindsupport'];
		$jb_mealsaday = $_REQUEST['jb_mealsaday'];
		$jb_is_disabled = $_REQUEST['jb_is_disabled'];
		$jb_disability = $_REQUEST['jb_disability'];
		$jb_is_immobile = $_REQUEST['jb_is_immobile'];
		$jb_assistive = $_REQUEST['jb_assistive'];
		$jb_is_ill = $_REQUEST['jb_is_ill'];
		$jb_illness = $_REQUEST['jb_illness'];
		$jb_physicalcondition = $_REQUEST['jb_physicalcondition'];
		$resulter = $custom_rep_add->_executeInsertSupport($jb_family_support,$jb_kindsupport,$jb_mealsaday,$jb_is_disabled,$jb_disability,$jb_is_immobile,$jb_assistive,$jb_is_ill,$jb_illness,$jb_PensionerID,CurrentUserID(),$jb_physicalcondition);
		if ($resulter == 1) {
		?>
		<div class="alert alert-success">
			Add Success!
