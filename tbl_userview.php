...
ftbl_userview.Lists["x_region_code"] = {"LinkField":"x_region_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_region_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($tbl_user->region_code->Visible) { // region_code ?>
	<tr id="r_region_code">
		<td><span id="elh_tbl_user_region_code"><?php echo $tbl_user->region_code->FldCaption() ?></span></td>
...
<?php echo $tbl_user->region_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tbl_user->activated->Visible) { // activated ?>
	<tr id="r_activated">
		<td><span id="elh_tbl_user_activated"><?php echo $tbl_user->activated->FldCaption() ?></span></td>
...
<?php echo $tbl_user->activated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
