...
include_once "model/dashboardDAO.php";
$DashBoardDAO = new DashBoardDAO();
$reportQueryList = $DashBoardDAO->getReportQueryList();
	foreach($reportQueryList as $reportQueryData){ ?>
	<div class="col-sm-12">
		<div class="widget-box transparent">
			<div class="widget-header widget-header-flat">
				<h4 class="lighter">
					<i class="icon-star orange"></i>
					<?php echo $reportQueryData['mycaption']; ?>
				</h4>
			...
			<div class="widget-body">
				<div class="widget-main no-padding" style="height:<?php echo ($reportQueryData['chart_height']+50); ?>px;">
					<iframe  frameborder="0" width="100%" height="1600" src="reports/report.php?&rpt_id=<?php echo $reportQueryData['report_id']; ?>&stack=<?php echo $reportQueryData['stack']; ?>&cwidth=100%&cheight=<?php echo $reportQueryData['chart_height']; ?>&switched=1&trans=<?php echo $reportQueryData['transpose_result']; ?>">Browser does not support IFrames</iframe>
				</div><!-- /widget-main -->
			</div><!-- /widget-body -->
		</div><!-- /widget-box -->
	</div>
