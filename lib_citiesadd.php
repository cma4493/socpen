...
$lib_cities_add = NULL; // Initialize page object first

class clib_cities_add extends clib_cities {
	...
	// Page object name
	var $PageObjName = 'lib_cities_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "lib_citiesview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// district_name
		$this->district_name->SetDbValueDef($rsnew, $this->district_name->CurrentValue, "", FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && $this->city_code->CurrentValue == "" && $this->city_code->getSessionValue() == "") {
...
// Create page object
if (!isset($lib_cities_add)) $lib_cities_add = new clib_cities_add();

// Page init
$lib_cities_add->Page_Init();

// Page main
$lib_cities_add->Page_Main();
...
// Page object
var lib_cities_add = new ew_Page("lib_cities_add");
lib_cities_add.PageID = "add"; // Page ID
var EW_PAGE_ID = lib_cities_add.PageID; // For backward compatibility

// Form object
var flib_citiesadd = new ew_Form("flib_citiesadd");
...
flib_citiesadd.Form_CustomValidate = 
...
flib_citiesadd.ValidateRequired = true;
<?php } else { ?>
flib_citiesadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="flib_citiesadd" id="flib_citiesadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="lib_cities">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_lib_citiesadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_city_code" name="x_city_code" id="x_city_code" size="30" placeholder="<?php echo $lib_cities->city_code->PlaceHolder ?>" value="<?php echo $lib_cities->city_code->EditValue ?>"<?php echo $lib_cities->city_code->EditAttributes() ?>>
</span>
