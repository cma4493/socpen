...
$lib_brgy_view = NULL; // Initialize page object first

class clib_brgy_view extends clib_brgy {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["brgy_code"] <> "") {
			$this->RecKey["brgy_code"] = $_GET["brgy_code"];
			$KeyUrl .= "&brgy_code=" . urlencode($this->RecKey["brgy_code"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["brgy_code"] <> "") {
				...
				$this->RecKey["brgy_code"] = $this->brgy_code->QueryStringValue;
			} else {
				$sReturnUrl = "lib_brgylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lib_brgylist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "lib_brgylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($lib_brgy_view)) $lib_brgy_view = new clib_brgy_view();

// Page init
$lib_brgy_view->Page_Init();

// Page main
$lib_brgy_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lib_brgy_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var lib_brgy_view = new ew_Page("lib_brgy_view");
lib_brgy_view.PageID = "view"; // Page ID
var EW_PAGE_ID = lib_brgy_view.PageID; // For backward compatibility

// Form object
var flib_brgyview = new ew_Form("flib_brgyview");

// Form_CustomValidate event
flib_brgyview.Form_CustomValidate = 
...
flib_brgyview.ValidateRequired = true;
<?php } else { ?>
flib_brgyview.ValidateRequired = false; 
<?php } ?>
...
<?php $lib_brgy_view->ExportOptions->Render("body") ?>
<?php if (!$lib_brgy_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($lib_brgy_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $lib_brgy_view->ShowPageHeader(); ?>
<?php
$lib_brgy_view->ShowMessage();
?>
<form name="flib_brgyview" id="flib_brgyview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="lib_brgy">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_lib_brgyview" class="table table-bordered table-striped">
<?php if ($lib_brgy->brgy_name->Visible) { // brgy_name ?>
	<tr id="r_brgy_name">
		<td><span id="elh_lib_brgy_brgy_name"><?php echo $lib_brgy->brgy_name->FldCaption() ?></span></td>
...
<?php echo $lib_brgy->brgy_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_brgy->city_code->Visible) { // city_code ?>
	<tr id="r_city_code">
		<td><span id="elh_lib_brgy_city_code"><?php echo $lib_brgy->city_code->FldCaption() ?></span></td>
...
<?php echo $lib_brgy->city_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_brgy->brgy_code->Visible) { // brgy_code ?>
	<tr id="r_brgy_code">
		<td><span id="elh_lib_brgy_brgy_code"><?php echo $lib_brgy->brgy_code->FldCaption() ?></span></td>
...
<?php echo $lib_brgy->brgy_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $lib_brgy->district_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
